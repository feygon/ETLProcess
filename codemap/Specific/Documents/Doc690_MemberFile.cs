...
namespace BasicPreprocess.Specific
{
    ...
    /// </summary>
    internal sealed class MemberRecord : BasicDoc, iDocType_Takes_StringMap<MemberRecord>
    {
        ...
        /// </summary>
        public MemberRecord() : base(null, "Billing Account Number") { }
        ...
        /// <returns></returns>
        public MemberRecord GetT(StringMap stringMap, string[] headers)
        {
            return new MemberRecord(stringMap, headers);
        }
