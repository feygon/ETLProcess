...
namespace ETLProcess {
    ...
    internal static class Program
    {
        ...
        private static FilesIn_XMLOut PreP;
        ...
        private static void Main(string[] args)
        {
            try
            {
                ...
                PreP = new FilesIn_XMLOut(args[0]);
                client = new ClientETLProcess(PreP);
...
/*        //            if (MCSB691.Count == 0 && implementation == "W")
        ...
        //                using DataTable docGenWebAccounts = GetClientAccounts.Execute();
