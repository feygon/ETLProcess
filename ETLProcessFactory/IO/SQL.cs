...
namespace ETLProcessFactory.IO
{
    public static class SQL
    {
        ...
        public static DataTable ExecuteSQLCommand(string connectionString, string commandString)
        {
        ...
        /// <returns>A new DataTable object populated with the results of the query commandString. Returns null in case of an error.</returns>
        public static DataTable ExecuteBuiltCommandReturnQuery(SqlCommand command, DataTable table = null)
        {
        ...
        public static int ExecuteBuiltCommandNonQuery(SqlCommand command)
        {
            // Open the connection and read in data
            command.Connection.Open();
