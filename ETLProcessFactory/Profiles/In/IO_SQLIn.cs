...
namespace ETLProcessFactory.Profiles
{
    ...
    public class IO_SQLIn : SingletonProfile<IO_SQLIn>, IDisposable {
        ...
        private readonly string sqlInCmd = File.ReadAllText($@"{IODirectory.AssemblyDirectory}\{
        ...
        public static bool PreCheck_Input(DelRet<bool, string[]> inputs, string sqlFileName = "SQLInput.sql")
        {
            ...
            throw new NotImplementedException("What is sample for? What is inputs for?");
            return inputs(new string[]{ sqlFileName });
        }
        /// <summary>
