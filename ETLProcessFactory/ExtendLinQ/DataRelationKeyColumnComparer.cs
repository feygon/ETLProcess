...
namespace ETLProcessFactory.ExtendLinQ {
    /// <summary>
    ...
    public class DataRelationKeyColumnComparer : IEqualityComparer<DataRow>
    {
        ...
        private string GetHashString(DataRow row) {
            ...
            string keyStr = IODirectory.PrepGuid.ToString().Substring(0, 8);
            DataColumn[] keyCols;
        ...
        public int GetHashCode(DataRow obj) {
            ...
            string hashStr = IODirectory.PrepGuid.ToString().Substring(0,8);
